...
@section('container')
    ...
    <div class="section-header d-flex justify-content-between">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Jenis Organisasi</div>
        </div>
    </div>
    ...
    <script>
        ...
        function query() {
            var table = $('#table').DataTable({
                ...
                searching: true,
                retrieve: true,
                ajax: "{{ route('jenisOrganisasi.index') }}",
            ...
            $('#table tbody').on('click', 'tr', function() {
                if ($(this).hasClass('selected')) {
                    ...
                    $('#nama_organisasi').val(data[0].nama_organisasi);
        ...
        function add() {
            if ($("#nama_organisasi").val() === "" || $("#nama_organisasi").val() === null) {
                Swal.fire(
                    'Error',
                    'Field Nama Organisasi Cannot Be Null',
                    'error'
                );
            }
        ...
        function update() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('jenisOrganisasi.update') }}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    id_jenis: id_jenis,
                    nama_organisasi: nama_organisasi,
