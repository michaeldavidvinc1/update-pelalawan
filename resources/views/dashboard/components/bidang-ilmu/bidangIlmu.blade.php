...
@section('container')
    ...
    <div class="section-header d-flex justify-content-between">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Bidang Ilmu</div>
        </div>
    </div>
                ...
                <div id="accordion">
                    <div class="accordion">
                        <div class="accordion-header" role="button" data-toggle="collapse" data-target="#info"
                            aria-expanded="true">
                            <h4>Bidang Ilmu Info</h4>
                        </div>
                        <div class="accordion-body collapse show" id="info" data-parent="#accordion">
                            <form action="#">
                                @csrf
                                <input type="hidden" id="id_bidang_ilmu" name="id_bidang_ilmu">
                                <div class="row mt-2">
