...
@section('container')
    ...
    <div class="section-header d-flex justify-content-between">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Status Kawin</div>
        </div>
    </div>
                ...
                <div id="accordion">
                    <div class="accordion">
                        <div class="accordion-header" role="button" data-toggle="collapse" data-target="#info"
                            aria-expanded="true">
                            <h4>Status Kawin Info</h4>
                        </div>
                        <div class="accordion-body collapse show" id="info" data-parent="#accordion">
                            <form action="#">
                                @csrf
                                <input type="hidden" id="id_status_kawin" name="id_status_kawin">
                                <div class="row mt-2">
    ...
    <script>
        ...
        function add() {
            if ($("#status_kawin").val() === "" || $("#status_kawin").val() === null) {
                Swal.fire(
                    'Error',
