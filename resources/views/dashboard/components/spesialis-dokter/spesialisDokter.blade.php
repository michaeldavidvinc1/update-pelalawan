...
@section('container')
    ...
    <div class="section-header d-flex justify-content-between">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">Spesialis Dokter</div>
        </div>
    </div>
                            ...
                            <form action="#">
                                ...
                                <div class="row mt-2">
                                    <div class="form-group row col-6">
                                        <label class="col-sm-3 " style="color:red"><strong>Spesialis Dokter*</strong></label>
                                        <div class="col-sm-9">
    ...
    <script>
        ...
        function query() {
            var table = $('#table').DataTable({
                ...
                searching: true,
                retrieve: true,
                ajax: "{{ route('spesialisDokter.index') }}",
            ...
            $('#table tbody').on('click', 'tr', function() {
                if ($(this).hasClass('selected')) {
                    ...
                    $('#nama_spesialis').val(data[0].nama_spesialis);
        ...
        function add() {
            if ($("#nama_spesialis").val() === "" || $("#nama_spesialis").val() === null) {
                Swal.fire(
                    'Error',
                    'Field Spesialis Dokter Cannot Be Null',
                    'error'
                );
            }
        ...
        function update() {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('spesialisDokter.update') }}",
                data: {
                    "_token": "{{ csrf_token() }}",
